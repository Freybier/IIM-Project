...
public class StundenplanFrame extends javax.swing.JFrame {
    ...
    private void dozentZugListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dozentZugListMouseClicked
        ...
        if(getObjectFromName(textLabel, zugList) != null || getObjectFromName(textLabel, dozentenList) != null || getObjectFromName(textLabel, lvList) != null){
            ...
            if(getObjectFromName(textLabel, zugList) != null){
                ...
                jLVList.setModel(setLVDozentList());
            }else if (getObjectFromName(textLabel, lvList) != null){
